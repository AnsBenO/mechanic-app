    ...
    <tr class="hover:bg-gray-100 dark:hover:bg-gray-900">
        ...
        <td class="px-4 py-2 flex justify-center gap-3">
            <button onclick="showEditModal({{ $vehicle->id }})"
                class="btn btn-sm btn-info inline-flex items-center px-3 py-1 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-amber-200">
...
{{-- <tr>
    <td colspan="6" class="text-center">{{ $vehicles->links() }}</td>
</tr> --}}
